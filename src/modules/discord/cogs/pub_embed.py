...
class Functions:
    # Docker full dir: /home/container/data/discord/database.json
...
# V2.1.0 - Config commands removed in favour of Pterodactyl egg configuration on startup and auto check on boot
    ...
    async def updateEmbed(self):
        try:
            ...
            channel_id = os.getenv("PUB_EMBED_CHANNEL_ID", "")
