...
class Rust():
    def __init__(self) -> None:
        ...
        self.port = 28016 #This is one number higher than the server port, which is 28015
    ...
    async def fetch(self) -> tuple:
        ...
        Returns:
            ...
            ```
        """
        logging.info("Fetching RUST server info...")
        ...
        logging.info("Fetching RUST server info... Done!")
